<?php
    ...
    if (isset($_COOKIE["jetaid"])){
	   ...
	   try{
		   ...
		   if((isset($_POST["e_marresi"]))&&(isset($_POST["h_marresi"]))&&(isset($_POST["h_msg"]))){
          ...
          ?>
           <div class="trupi">
         	  <div class="kat_p" id="p_m"><!-- Paneli majtas -->
         	  	...
         	  	<?php echo listo_bisedat($id,-1, $lidhjar); ?>
         	  </div>
         	
          <div class="kat_p" id="p_mes"><!-- Paneli Mesit -->
          	    <?php 
          	    if(isset($_GET["marresi"]))echo msg_i_ri($id,$_GET["marresi"],$lidhjar);
